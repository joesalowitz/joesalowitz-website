...
const ButtonShimmer: React.FC<ButtonShimmerProps> = ({
    ...
    return (
        ...
        >
            ...
            <div className="relative z-40 w-full text-sm inline-flex animate-shimmer items-center justify-center border border-amber-400 bg-[linear-gradient(110deg,#f59e0b,25%,#fbbf24,65%,#f59e0b)] bg-[length:200%_100%] px-6 py-4 rounded-xl font-semibold text-amber-900
                transition-all 
